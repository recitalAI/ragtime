...
ragtime.config.init_win_env(['SEARCH_USERNAME', 'SEARCH_PASSWORD', 'SEARCH_URL_LOGIN', 'SEARCH_URL_SEARCH', 'LSA_TOKEN'])
...
SEARCH_USERNAME: str = os.environ.get("SEARCH_USERNAME")
SEARCH_PASSWORD: str = os.environ.get("SEARCH_PASSWORD")
SEARCH_URL_LOGIN: str = os.environ.get("SEARCH_URL_LOGIN")
SEARCH_URL_SEARCH: str = os.environ.get("SEARCH_URL_SEARCH")

class Search(Retriever):
    """
    LSA Retriever queries reciTAL Search
    """
    token: str = os.environ.get("LSA_TOKEN")
    ...
    def retrieve(self, qa: QA):
        ...
        if "folder_id" in qa.question.meta:
            params["folder_id"] = qa.question.meta["folder_id"]
